    ...
    <main>
      ...
      <div className="two-cols container">
        <div>
          ...
          <div className="text">
            <p>
              Don't got the money but have the skill? Get the top score and get the NFT. 
            </p>
            <p>
              No more WL grind, no more gas wars. It's time we socialized NFTs and make web3 fun again. May the best player win!
            </p>
            <p>
              Each week is a new tournament with one NFT up for grabs. Top score at the end wins the NFT - play as many times as you want. Top 100 of the leaderboard (except #1) splits 10% of the entry funds raised proportionally based on their score. 60% of funds go to the NFT provider, the rest goes to the community. Put your money where your mouth is and compete to win in <strong>The Arcade.</strong>
            </p>
          </div>
        </div>
      ...
      <div className="one-col container">
        <div>
          ...
          <div className="text">
            <p>
              We believe in making the NFT space fun again. No more long WL process, fighting with bots and going through the same steps for every project. It's time to reward your digital skill with digital rewards. 
            </p>
            <p>
